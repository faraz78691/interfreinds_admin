...
export class RecommendUserService {
  ...
  UpdateStatusAccept(data: any): Observable<any> {
    return this.http.post<any>('https://www.creativethoughtsinfo.com/CT01/interfriends_admin/Api/Admin/recommendUser_status', data);
  }
  viewRecommnedUserForm(data: any): Observable<any> {
    return this.http.post<any>('https://www.creativethoughtsinfo.com/CT01/interfriends_admin/Api/Admin/userDetailInfo', data);
  }
